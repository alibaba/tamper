package com.alibaba.mapping.script;
...
public class ScriptExecutorTest extends TestCase {
    ...
    public void test_system() {
        System.setProperty("BeanMapping.Script.Executor", "com.alibaba.mapping.process.script.jexl.JexlScriptExecutor");
